...
Ansible playbooks for setting up a LEMP stack for Magento.

- Local development environment with Vagrant
- High-performance production servers
- One-command deploys for your Magento sites
...
1. Configure your WordPress sites in `group_vars/development/magento_sites.yml` and in `group_vars/development/vault.yml`
2. Run `vagrant up`
...
1. Configure your Magento sites in `group_vars/<environment>/magento_sites.yml` and in `group_vars/<environment>/vault.yml` (see the [Vault docs](https://roots.io/trellis/docs/vault/) for how to encrypt files containing passwords)
...
1. Add the `repo` (Git URL) of your Magento project in the corresponding `group_vars/<environment>/magento_sites.yml` file
